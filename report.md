...
An instruction on how to run this project is specifiec in the readme.md file
...
The generation of the x and y coordinates are created randomly following a gaussian distributon, where the mean is changed randomly each 2500th message and the variance is fixed. The 115 twitter messages used in the producer are looped, so that the producer always have messages to work with.
...
Each message is created iterativly and continiously sent by the producer to the kafka queue. The messages sent to kafka is partinioned in the topic "covid",
...
The dashbard was created as a python program in the jupyter notebook format. Running the entire notebook visualizes the data stored in Cassandra by drawing clusters on a map of Stockholm. This is illustraded in the image below:

<p align="center"><img align = "center" src="map.png" width="50%"></p>
